"""
Starter fabfile for deploying the quizme project.
...
# CHANGEME
env.hosts = ['user@quizme.example.com']
env.code_dir = '/srv/www/quizme'
env.project_dir = '/srv/www/quizme/quizme'
env.static_root = '/srv/www/quizme/static/'
env.virtualenv = '/srv/www/quizme/.virtualenv'
env.code_repo = 'git@github.com:user/quizme.git'
env.django_settings_module = 'quizme.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/quizme/wsgi.py" % env.code_dir)
